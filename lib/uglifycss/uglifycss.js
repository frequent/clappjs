...
(function () {
   ...
   */
  uglifycss.extractDataUrls = function (css, preservedTokens) {
   ...
   * @returns String The processed css
   */
  uglifycss.compressHexColors = function (css) {
  ...
  // Uglify a CSS string
  uglifycss.processString = function (content, options) {
