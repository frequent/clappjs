...
(function (window, document, RSVP) {
  ...
  request = function (module_list) {
    ...
    setLoadingOrder(module_list).forEach(function (el, index) {
      ...
      // this returns too early, because it does not wait for dependencies
      // of a module. Once the module is loaded it fires!
      // Of course it does, because the dependencies are not declared and
      // will only be read once the returned module is called.
      // so in this case I'm returning the module = render = {}
